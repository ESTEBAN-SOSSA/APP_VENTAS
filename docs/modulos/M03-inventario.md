...
## Entidades
- `Insumo(id, nombre, categoria_id, unidad_medida, stock_actual, stock_minimo, costo_unitario, proveedor_id?, activo)`
...
- Las anulaciones de venta **devuelven** insumos al inventario ([M08](M08-ventas-cobro-caja.md)).

## Criterios de aceptación
- [ ] La venta descuenta inventario (directo y por receta) correctamente.
- [ ] Existe historial de movimientos por insumo.
